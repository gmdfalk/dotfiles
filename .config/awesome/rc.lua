...
globalkeys = awful.util.table.join(
    ...
    awful.key({},   "XF86Explorer",   function () run_or_raise("pcmanfm", { class = "Pcmanfm" }) end,
              {description = "Launch Explorer", group = "xf86"}),
    awful.key({},   "XF86Calculator", function () sexec("gnome-calculator") end,
